...
@WebService(serviceName = ExtendedSoapProfiles.NAME, targetNamespace = ExtendedSoapProfiles.NAMESPACE, endpointInterface = ExtendedSoapProfiles.INTERFACE)
public interface ExtendedSoapProfiles {
