...
public class f_FollowProfilesStats extends MicrogramTestOperations {

	public f_FollowProfilesStats(boolean parallel, int restProfilesServers, int soapProfilesServers, int restPostsServers, int soapPostsServers, String description) {
