package tests._5_microgram_base.discovery;
...
public class _01_Discovery extends MicrogramTest {

	public _01_Discovery(boolean parallel, int restProfilesServers, int soapProfilesServers, int restPostsServers, int soapPostsServers, String description) {
